 ...
 */
public class HxzImageView2 extends AppCompatImageView {
    ...
    public HxzImageView2(Context context) {
        this(context, null);
    }

    public HxzImageView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            xRound = a.getDimensionPixelSize(R.styleable.hxzImageview_XRound, 0);
