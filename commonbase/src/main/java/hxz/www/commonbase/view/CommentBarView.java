...
public class CommentBarView extends View {
    ...
    private boolean isControlMark = true;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.starDistance = (int) mTypedArray.getDimension(R.styleable.RatingBar_star_distance, 10);
        this.starSize = (int) mTypedArray.getDimension(R.styleable.RatingBar_star_size, 30);
        this.starCount = mTypedArray.getInteger(R.styleable.RatingBar_star_count, 5);
        this.starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_star_empty);
        this.starFillBitmap = drawableToBitmap(mTypedArray.getDrawable(R.styleable.RatingBar_star_fill));
        mTypedArray.recycle();
        paint = new Paint();
     ...
     * @param isControlMark
     */
    public void setControlMark(boolean isControlMark) {
        this.isControlMark = isControlMark;
    }
